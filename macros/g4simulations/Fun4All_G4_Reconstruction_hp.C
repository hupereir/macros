...
int Fun4All_G4_Reconstruction_hp( const int nEvents = 5000, const char* inputFile = "DST/dst_sim_5k_low_momentum.root", const char *outputFile = "DST/dst_reco_5k_truth_low_momentum.root" )
{
