  ...
  const char *outputFile = "DST/dst_eval.root" )
{
  ...
  // G4TPC::correction_filename = "distortion_maps_rec/Distortions_full_realistic_micromegas_mm-empty.root";
  // G4TPC::correction_filename = "distortion_maps_rec/Distortions_full_realistic_micromegas_mm-empty_extrapolated.root";
