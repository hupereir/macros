 ...
 )
{
  ...
  // print inputs
  std::cout << "Fun4All_G4_ClusterReconstruction_hp - nEvents: " << nEvents << std::endl;
  std::cout << "Fun4All_G4_ClusterReconstruction_hp - nSkipEvents: " << nSkipEvents << std::endl;
  std::cout << "Fun4All_G4_ClusterReconstruction_hp - inputFile: " << inputFile << std::endl;
  std::cout << "Fun4All_G4_ClusterReconstruction_hp - outputFile: " << outputFile << std::endl;
  std::cout << "Fun4All_G4_ClusterReconstruction_hp - spaceChargeMatricesFile: " << spaceChargeMatricesFile << std::endl;
  std::cout << "Fun4All_G4_ClusterReconstruction_hp - residualsFile: " << residualsFile << std::endl;
